...
- **Download LLaMA-3.2-3B-Instruct Q4_K_S GGUF** and place in `models/llama-3.2-3b-instruct-q4_K_S.gguf` (or use Ollama to pull and copy from `~/.ollama/models/blobs/`). **Note:** Model files are excluded from git (see `.gitignore`).
